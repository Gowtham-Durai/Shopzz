...
import CartLi from '../../Components/CartLi/CartLi';
...
const Cart = () => {
  ...
  return (
    ...
    <div className={style.cart_container}>
        ...
        {
            carts.map((val,idx)=>{
              return <CartLi  data={val} key={idx}/>
            })
          }
        </div>
            ...
            <div className={style.check_details_container}>
                ...
                <div className="discount">
                    <span>Discount: </span>
                      <div>
                            <input type="number" placeholder='Discount' onChange={handleDiscount} min={0} max={100} value={discount}/>
                            <span>%</span>
                        </div>
                </div>
